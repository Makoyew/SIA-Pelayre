              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col space-y-4">
                  ...
                  <div class="mt-auto flex justify-end">
                    <div class="space-x-2">
                      <Link class="button13 mr-2" :href="'/customers/' + customer.id" method="delete" as="button">Delete</Link>
                      <Link class="button12 mb-2" :href="'/customers/edit/' + customer.id" as="button">Edit</Link>
                    </div>
                  </div>
                </div>
              </div>
